...
import com.roadmate.shop.ui.fragments.ShopEditFragmentFirst
...
class ShopEditActivity : BaseActivity(), AppLocationListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setFragment(ShopEditFragmentFirst(), FragmentConstants.SHOP_EDIT_FRAGMENT_FIRST, intent.extras, false)
    }

    override fun onBackPressed() {
        var fragment: ShopEditFragmentSecond? = supportFragmentManager.findFragmentByTag(FragmentConstants.SHOP_EDIT_FRAGMENT_SECOND) as? ShopEditFragmentSecond
        if (fragment is  ShopEditFragmentSecond){
